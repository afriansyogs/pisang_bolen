...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            ...
            <button class="navbar-toggler border-2 border-black" type="button" data-bs-toggle="collapse"
                ...
                <ul class="navbar-nav">
                    <li class="nav-item mx-2 mt-2 {{ \Route::is('cart.index') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('cart.index') }}"><i
                                class="fa-solid fa-cart-shopping fa-xl text-white"></i></a>
                    </li>
                    <li class="nav-item mx-2 mt-2 {{ \Route::is('profile-show') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('profile-show') }}"><i
                                class="fa-solid fa-box fa-xl text-white"></i></a>
                    </li>
                    <li class="nav-item mx-2 mt-2 {{ \Route::is('profile-show') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('profile-show') }}"><i
                                class="fa-solid fa-circle-user fa-xl text-white"></i></a>
                    </li>
                </ul>
